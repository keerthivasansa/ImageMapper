package com.keerthivasan.imagemapper.screens.createSeller
...
class CreateSeller : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            AppShell(title = "Create Seller", backButton = true) {
                SellerScreen()
            }
        }
    }
...
fun SellerScreen() {
    ...
    Column(
        ...
        TextField(
            value = numberInput, { numberInput = it }, modifier = Modifier.padding(top = 12.dp),
